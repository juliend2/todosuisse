...
class TaskTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_template" do
    assert_difference('TaskTemplate.count') do
      post task_templates_url, params: { task_template: { description: @task_template.description, from_day: @task_template.from_day, repeating_interval: @task_template.repeating_interval } }
    end
  ...
  test "should update task_template" do
    patch task_template_url(@task_template), params: { task_template: { description: @task_template.description, from_day: @task_template.from_day, repeating_interval: @task_template.repeating_interval } }
